  ...
  return (
    <div className={css(styles.body)}>
        ...
        <p className={css(styles.main_instructions)}>
          Seleccione el tipo de materíal que se desea reciclar. Recibirás una lista de los puntos de reciclaje mas proximos que traten el material seleccionado.
        </p>
            ...
            <div>
                <div >
                    ...
                    <select className={css(styles.select)}>
                      <option className={css(styles.options)} value='Buenos Aires'>Buenos Aires</option>
                      <option className={css(styles.options)} value='Mendoza'>Mendoza</option>
                      <option className={css(styles.options)} value='Tierra del Fuego'>Tierra del Fuego</option>
                    </select>
